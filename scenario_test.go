...
func TestScenario_CreateMultiMemberGroup(t *testing.T) {
	cases := []testCase{
		{"2 clients/connectAll", 2, ConnectAll, testutil.Fast, testutil.Flappy, time.Second * 10},
		{"3 clients/connectAll", 3, ConnectAll, testutil.Fast, testutil.Flappy, time.Second * 10},
		{"3 clients/connectInLine", 3, ConnectInLine, testutil.Fast, testutil.Flappy, time.Second * 10},
		{"5 clients/connectAll", 5, ConnectAll, testutil.Slow, testutil.Flappy, time.Second * 20},
		{"5 clients/connectInLine", 5, ConnectInLine, testutil.Slow, testutil.Flappy, time.Second * 20},
		{"8 clients/connectAll", 8, ConnectAll, testutil.Slow, testutil.Flappy, time.Second * 30},
		{"8 clients/connectInLine", 8, ConnectInLine, testutil.Slow, testutil.Flappy, time.Second * 30},
		{"10 clients/connectAll", 10, ConnectAll, testutil.Slow, testutil.Flappy, time.Second * 40},
		{"10 clients/connectInLine", 10, ConnectInLine, testutil.Slow, testutil.Flappy, time.Second * 40},
	}
...
func testGroupDeviceStatus(ctx context.Context, t *testing.T, groupID []byte, tps ...*TestingProtocol) {
	ntps := len(tps)
...
func TestScenario_AddContact(t *testing.T) {
	cases := []testCase{
		{"2 clients/connectAll", 2, ConnectAll, testutil.Fast, testutil.Flappy, time.Second * 20},
		{"3 clients/connectAll", 3, ConnectAll, testutil.Fast, testutil.Flappy, time.Second * 20},
		{"5 clients/connectAll", 5, ConnectAll, testutil.Slow, testutil.Flappy, time.Second * 30},
		{"8 clients/connectAll", 8, ConnectAll, testutil.Slow, testutil.Flappy, time.Second * 40},
		{"10 clients/connectAll", 10, ConnectAll, testutil.Slow, testutil.Flappy, time.Second * 60},
	}
...
func getContactGroup(ctx context.Context, t *testing.T, source *TestingProtocol, contact *TestingProtocol) *protocoltypes.GroupInfo_Reply {
	// Get contact group
